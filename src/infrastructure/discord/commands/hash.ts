...
export const hashCommand = new SlashCommandBuilder()
  ...
  .addStringOption((option) =>
    option.setName('text').setDescription('Текст для хеширования').setRequired(true)
  )
  .addStringOption((option) =>
    option
      .setName('algorithm')
...
export async function handleHashCommand(interaction: ChatInputCommandInteraction): Promise<void> {
